window.addEventListener("DOMContentLoaded",function(e){
    ...
    var botonLogin = document.getElementById("enviarLogin");
    ...
    if (botonLogin) {
            botonLogin.addEventListener("click", function(e){
                ...
                if (password.value.length === 0 && usuario.value.length === 0) {
                    ...
                    mensaje.textContent = "Inserte su correo y contraseña";
    ...
    function eliminarMensajesLogin(){
        botonLogin.disabled = false;
        if(document.getElementById("mensaje")){
            form.removeChild(mensaje);
        }
